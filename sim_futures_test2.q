...
refreshPnl:{[tbl]
    ...
    hclose h;    
    tt:(`product xkey tbl) lj (`product xkey select product, SimuFee, FeeMode from update product:MyProduct from feedata);
    ...
    tt:0!delete SimuFee,FeeMode from (tt1,tt2);
    (HDBCOLS except`date) xcols tt
  }
